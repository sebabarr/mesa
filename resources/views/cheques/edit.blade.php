    ...
    {!! Form::model($cheque, [
        ...
        'class' => 'form-horizontal'
            ...
            <div class="form-group {{ $errors->has('importe') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::number('importe', null, ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('descgasto') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::number('descgasto', null, ['class' => 'form-control']) !!}
            ...
            <div class="form-group {{ $errors->has('descfijo') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::number('descfijo', null, ['class' => 'form-control']) !!}
